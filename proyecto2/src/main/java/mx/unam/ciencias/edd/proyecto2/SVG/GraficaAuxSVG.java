...
public class GraficaAuxSVG extends Grafica {
	...
	private static VerticeGrafica<Integer> vi = null;
	...
	public static String obtenerVertices(Grafica<Integer> g, double radioG, int radio, double x, double y, SVGUtils utils)  {
